...
#define BSLV_MAIN_H
	...
	#define THISPROGRAM "bensolve"
	#define MAX_OPTION_STR_LNGTH 20 // adopt string length when changing these strings
	#define VALID_BOOL_OPTIONS "bgs"
	#define VALID_STRING_OPTIONS "kLlmMAaEe"
	#define MAX_OPTION_ENTRY_STR_LNGTH 100
